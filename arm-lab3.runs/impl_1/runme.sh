...
HD_PWD='C:/Users/Evan/Documents/SYSC_4310_ARM_Verilog/arm-lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ArmProcessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ArmProcessor.tcl -notrace
