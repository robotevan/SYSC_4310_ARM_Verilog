...
HD_PWD='C:/Users/Evan/Documents/SYSC_4310_ARM_Verilog/arm-lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ArmProcessor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ArmProcessor.tcl
